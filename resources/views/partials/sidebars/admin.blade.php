<a href="#" class="flex items-center text-gray-300 hover:bg-gray-700 px-3 py-2 rounded transition group">
...
<a href="#" class="flex items-center text-gray-300 hover:bg-gray-700 px-3 py-2 rounded transition group">
  ...
  <span class="ml-3 sidebar-text hidden group-hover:inline transition-all duration-300">Add Departmen</span>
</a>
<a href="#" class="flex items-center text-gray-300 hover:bg-gray-700 px-3 py-2 rounded transition group">
