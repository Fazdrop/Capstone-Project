...
<a href="{{ route('admin.roles.index') }}"
    class="flex items-center px-3 py-2 rounded transition group
          {{ Request::routeIs('admin.roles.*') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-700' }}">
    <i data-feather="award" class="w-5 h-5 transition-all duration-200"></i>
    <span class="ml-3 sidebar-text hidden">Role</span>
</a>
