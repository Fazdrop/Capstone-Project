...
<header class="fixed top-0 left-0 w-full z-50 bg-gray-800 text-white flex items-center justify-between px-4 py-3 shadow">
  ...
  <div class="relative">
    ...
    <div
      id="user-dropdown"
      class="hidden absolute right-0 mt-2 w-44 bg-white text-black rounded shadow-md z-50 origin-top-right transition-all duration-200 ease-out transform scale-95 opacity-0 pointer-events-none"
